# Task Manager - Extensão para Chrome (Bootcamp II)

![Project Screenshot](docs/screenshot.png)

Extensão para Google Chrome (Manifest V3) que funciona como um checklist para gerenciar tarefas e prazos, com integração de IA para sugestões e salvamento de eventos no Google Agenda. Este é o projeto final da Etapa Inicial do Bootcamp II.
